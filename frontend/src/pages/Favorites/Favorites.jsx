...
import { dataContext, favoritesContext, userShoppingCartContext } from "../../context/Context";
                    ...
                    <>
                        <div className="favorite-selection-btns">
                            ...
                            <a onClick={deleteSelectedFavs}>DELETE</a>
                                ...
                                <button onClick={addSelectedFavsToShoppingCart} className="add-to-cart-btn">ADD TO CART</button>
                            </>
                            ) : (
                            <>
